...
# ── NOTE: gensim and spacy are imported lazily inside their respective
#    classes so that the fraud-detection pipeline (which never uses
#    Word2Vec or SpaCy) can be unpickled on SageMaker without requiring
#    those heavy packages to be installed.
